...
public class BacklogStudentzList {
	...
	public BacklogStudentzList() {
		initialize();
	}
	
	public BacklogStudentzList(int fid) {
		this.FID = fid;
		initialize();
	}
	
	public BacklogStudentzList(String usn) {
		this.usn = usn;
		initialize();
	}
	...
	public void  initialize() {
		...
		l2 = new JLabel("SAHYADRI    STUDENT'S    BACKLOG    LIST");
...
//		// ********************************** JTABLE  CONFIGURATIONS *****************************************************
		...
		tableMode1.addColumn("BACKLOG COUNT");
			...
			public void actionPerformed(ActionEvent ae) {
					...
					if(btncount>0) {
					 ...
					 try {
				  			...
				  			String query = "select sid,sfname,slname,usn,count(subcode) as Backlog_Count "
				  					+ "from academiceligibility NATURAL JOIN student "
				  					+ "where usn in "
				  					...
				  					+ "group by usn having count(usn)>=1 order by Backlog_Count DESC;";
				  			...
				  			while(set.next()) {
				  				...
				  				int backlogcount = set.getInt(5);
				  				
				  				Object data[] = {sid,usn,fname+" "+lname,backlogcount};
...
//			}
	...
	public static void main(String[] args) {
		BacklogStudentzList bsl  = new BacklogStudentzList("4SF20CS004");
	}
