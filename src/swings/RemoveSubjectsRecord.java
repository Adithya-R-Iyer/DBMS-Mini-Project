...
public class RemoveSubjectsRecord {
	...
	public RemoveSubjectsRecord() {
		initialize();
	}
	
	public RemoveSubjectsRecord(String adname) {
	...
	public void initialize() {
		...
		tf1.addFocusListener(new FocusAdapter() {
		    public void focusGained(FocusEvent fe) {	
		    	if(tf1.getText().trim().equals("enter subcode"))
		        	tf1.setText("");
		    }
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if(stg.equals("DELETE") == true) {
					...
					int result = JOptionPane.showOptionDialog(null, "Do you want to delete Subject Records for SUBCODE : " + subcode, "Warning",
					 JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE,
					 null, options, options[1]);
					
					if(result == JOptionPane.YES_OPTION) {
					try {
	    				SubjectsTableOperationsDB.deletefromsubjectstable(subcode);
	    				JOptionPane.showMessageDialog(frame,"Successful !! Subject record deleted successfully","Success Message",JOptionPane.INFORMATION_MESSAGE);
	    			}
	    			catch(SQLException e) {
	    				JOptionPane.showMessageDialog(frame,"Unsuccessful !! Subject record not found.","Error Message",JOptionPane.ERROR_MESSAGE);
	    			}
					tf1.setText("");	
					}
	...
	public static void main(String[] args) {
		RemoveSubjectsRecord rsd = new RemoveSubjectsRecord();
	}
