...
public class DisplayFacultyClasses {
	...
	public DisplayFacultyClasses() {
		initialize();	
	}
	
	public DisplayFacultyClasses(int fid) {
		this.FID = fid;
		initialize();	
	}
	...
	public void initialize()  {
		...
		l2 = new JLabel("MY  CURRENTLY  ENROLLED  CLASSES");
...
//			table2.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		...
		tableMode3.addColumn("PHONE");
		tableMode3.addColumn("CITY");
		tableMode3.addColumn("GENDER");
		tableMode3.addColumn("DOB");
		tableMode3.addColumn("EMAIL");
		tableMode3.addColumn("PROJECTs");
		tableMode3.addColumn("INTERNSHIPs");
		tableMode3.addColumn("BACKLOGs");
...
//			table3.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		...
		tableMode4.addColumn("PHONE");
		tableMode4.addColumn("CITY");
		tableMode4.addColumn("GENDER");
		tableMode4.addColumn("DOB");
		tableMode4.addColumn("EMAIL");
		tableMode4.addColumn("PROJECTs");
		tableMode4.addColumn("INTERNSHIPs");
		tableMode4.addColumn("BACKLOGs");
...
//			    	  System.out.println(row);
			    	  ...
			    	  try {
				  			...
				  			String query = "select s.sid,s.sfname,s.slname,s.usn,s.sphno,s.scity,s.sgender,s.sdob,s.semail,aa.snoproj,aa.sinternship,aa.sbacklogs from student s,academicachievements aa where s.USN=aa.USN and si_id =?;";
						...
						while(set3.next()) {
							...
							String phone = set3.getString(5);
							String city = set3.getString(6);
							String gender = set3.getString(7);
							String dob = set3.getString(8);
							String email = set3.getString(9);
							int proj = set3.getInt(10);
							int intern = set3.getInt(11);
							int backlog = set3.getInt(12);
				
							Object data3[] = {sid,fname + " " + lname,usn,phone,city,gender,dob,email,proj,intern,backlog};
...
//						    	  System.out.println(row);
						    	  ...
						    	  try {
									...
									while(set4.next()) {
										...
										String phone = set4.getString(5);
										String city = set4.getString(6);
										String gender = set4.getString(7);
										String dob = set4.getString(8);
										String email = set4.getString(9);
										int proj = set4.getInt(10);
										int intern = set4.getInt(11);
										int backlog = set4.getInt(12);
							
										Object data4[] = {sid,fname + " " + lname,usn,phone,city,gender,dob,email,proj,intern,backlog};
...
//			    	  System.out.println("Entered");
	...
	public static void main(String[] args) {
		DisplayFacultyClasses dfs = new DisplayFacultyClasses(2);
	}
}