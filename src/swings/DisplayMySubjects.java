...
public class DisplayMySubjects {
	...
	public DisplayMySubjects() {
		initialize();	
	}
	
	public DisplayMySubjects(String usn) {
		this.USN = usn;
		initialize();	
	}
	...
	public void initialize()  {
		...
		l2 = new JLabel("MY  CURRENT  SEMESTER  SUBJECTS");
...
//		panel1.setPreferredSize(new Dimension(900,900));
		...
		if(si_id.substring(2,4).equals("CS")) {
			did=1;
		}
		else if(si_id.substring(2,4).equals("IS")) {
			did=2;
		}
		else if(si_id.substring(2,4).equals("AI")) {
			did=3;
		}
		else if(si_id.substring(2,4).equals("DS")) {
			did=4;
		}
		else if(si_id.substring(2,4).equals("ME")) {
			did=5;
		}
		else if(si_id.substring(2,4).equals("CI")) {
			did=6;
		}
		else if(si_id.substring(2,4).equals("EC")) {
			did=7;
		}
...
//			table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
		 ...
		 table.getTableHeader().setForeground(Color.WHITE);
			...
			tableMode1.addColumn("Dept NAME");
...
//		    	  cb1index = cb1.getSelectedIndex();
	...
	public static void main(String[] args) {
		DisplayMySubjects dsr = new DisplayMySubjects("4SF20CS004");
	}
}