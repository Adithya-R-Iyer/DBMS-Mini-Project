...
public class StudentIAPerformance {
	...
	public StudentIAPerformance() {
		initialize();	
	}
	
	public StudentIAPerformance(String usn) {
		this.USN = usn;
		initialize();	
	}
	...
	public void initialize()  {
		...
		l2 = new JLabel("MY  CURRENT  SEMESTER  IA  PERFORMANCE");
	  ...
	  //PANEL 1 CREATION - HOME BUTTON CONTENTS
	    ...
	    try {
			...
			String query = "Select s.subcode,s.sname,ia.IA1,ia.IA2,ia.IA3,ia.AssgnMrks,ia.FINALIA,s.scredits from iamarks ia,subjects s where ia.subcode=s.subcode and s.sem=? and usn=?;";
		 ...
		 table.getTableHeader().setForeground(Color.WHITE);
			...
			tableMode1.addColumn("IA1 MARKS");
			tableMode1.addColumn("IA2 MARKS");
			tableMode1.addColumn("IA3 MARKS");
			tableMode1.addColumn("ASSGN. MARKS");
			tableMode1.addColumn("FINAL IA MARKS");
			tableMode1.addColumn("CREDIT'S");
			
			while(set.next()) {
				String subcode = set.getString(1);
				String name = set.getString(2);
				int ia1 = set.getInt(3);
				int ia2 = set.getInt(4);
				int ia3 = set.getInt(5);
				int assgn = set.getInt(6);
				int finalia = set.getInt(7);
				int credits = set.getInt(8);
							
				Object data1[] = {subcode,name,ia1,ia2,ia3,assgn,finalia,credits};
...
//			sp.setViewportBorder(BorderFactory.createLineBorder(Color.black,2));
	 ...
	 table1.getTableHeader().setForeground(Color.WHITE);
		...
		tableMode2.addColumn("IA1 MARKS");
		tableMode2.addColumn("IA2 MARKS");
		tableMode2.addColumn("IA3 MARKS");
		tableMode2.addColumn("ASSGN. MARKS");
		tableMode2.addColumn("FINAL IA MARKS");
...
//						panel2.setVisible(false);
			    	...
			    	try {
						...
						while(set2.next()) {
							...
							int ia1 = set2.getInt(3);
							int ia2 = set2.getInt(4);
							int ia3 = set2.getInt(5);
							int assgn = set2.getInt(6);
							int finalia = set2.getInt(7);
							int credits = set2.getInt(8);
										
							Object data2[] = {subcode,name,ia1,ia2,ia3,assgn,finalia,credits};
	...
	public static void main(String[] args) {
		StudentIAPerformance dsr = new StudentIAPerformance("4SF20CS004");
	}
}